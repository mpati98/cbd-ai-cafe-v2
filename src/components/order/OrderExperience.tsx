...
export default function OrderExperience({
  ...
  return (
    <div className="flex min-h-screen flex-col bg-latte-950">
      ...
      <div className="flex flex-1 flex-col lg:flex-row">
        ...
        <aside className="order-1 h-[60vh] shrink-0 border-b border-latte-800 lg:order-2 lg:h-auto lg:w-1/3 lg:border-b-0 lg:border-l">
